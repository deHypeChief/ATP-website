...
interface LeaderboardEntry {
    tournamentId: string;
    gold: typeof Match.schema.methods | null;  // The match document or null if not present
    silver: typeof Match.schema.methods | null; // The match document or null if not present
    bronze: typeof Match.schema.methods | null; // The match document or null if not present
}
