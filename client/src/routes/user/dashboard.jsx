...
export function SelectedTourPayPage({ payload, action }) {
    ...
    const [tourStatus, setTourStatus] = useState("Checking Tour Status...");
        ...
        const checkMatchInfo = async () => {
            try {
                ...
                if (response.match) {
                    ...
                    setTourStatus(null); // No payment needed if already registered
                } else {
                    setTourStatus("Make Payment");
                    setPaymentLink(getTourPayLink(data._id));
    ...
    return (
        <div className="tourCenter">
            ...
            <div className="tourAction">
                {isPaymentPending && (
                    <Link to={paymentLink}>
                        <Button disabled={!isPaymentPending} full>
                            {tourStatus}
                        </Button>
                    </Link>
                )}
